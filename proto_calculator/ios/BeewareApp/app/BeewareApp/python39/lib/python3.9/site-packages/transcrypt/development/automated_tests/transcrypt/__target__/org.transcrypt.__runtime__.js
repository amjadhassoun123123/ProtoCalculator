...
function(aNumber){if(isinstance(aNumber,complex))return complex(aNumber.real,-aNumber.imag);else return complex(aNumber,0)};export var __Terminal__=__class__("__Terminal__",[object],{__module__:__name__,get __init__(){return __get__(this,function(self){self.buffer="";try{self.element=document.getElementById("__terminal__")}catch(__except0__){self.element=null}if(self.element){self.element.style.overflowX="auto";self.element.style.boxSizing="border-box";self.element.style.padding="5px";self.element.innerHTML=
"_"}})},get print(){return __get__(this,function(self){var sep=" ";var end="\n";if(arguments.length){var __ilastarg0__=arguments.length-1;if(arguments[__ilastarg0__]&&arguments[__ilastarg0__].hasOwnProperty("__kwargtrans__")){var __allkwargs0__=arguments[__ilastarg0__--];for(var __attrib0__ in __allkwargs0__)switch(__attrib0__){case "self":var self=__allkwargs0__[__attrib0__];break;case "sep":var sep=__allkwargs0__[__attrib0__];break;case "end":var end=__allkwargs0__[__attrib0__];break}}var args=
tuple([].slice.apply(arguments).slice(1,__ilastarg0__+1))}else var args=tuple();self.buffer="{}{}{}".format(self.buffer,sep.join(function(){var __accu0__=[];for(var arg of args)__accu0__.append(str(arg));return __accu0__}()),end).__getslice__(-4096,null,1);if(self.element){self.element.innerHTML=self.buffer.py_replace("\n","<br>").py_replace(" ","&nbsp");self.element.scrollTop=self.element.scrollHeight}else console.log(sep.join(function(){var __accu0__=[];for(var arg of args)__accu0__.append(str(arg));
return __accu0__}()))})},get input(){return __get__(this,function(self,question){if(arguments.length){var __ilastarg0__=arguments.length-1;if(arguments[__ilastarg0__]&&arguments[__ilastarg0__].hasOwnProperty("__kwargtrans__")){var __allkwargs0__=arguments[__ilastarg0__--];for(var __attrib0__ in __allkwargs0__)switch(__attrib0__){case "self":var self=__allkwargs0__[__attrib0__];break;case "question":var question=__allkwargs0__[__attrib0__];break}}}else;self.print("{}".format(question),__kwargtrans__({end:""}));
var answer=window.prompt("\n".join(self.buffer.py_split("\n").__getslice__(-8,null,1)));self.print(answer);return answer})}});export var __terminal__=__Terminal__();export var print=__terminal__.print;export var input=__terminal__.input;
