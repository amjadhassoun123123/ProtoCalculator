...
float,getattr,hasattr,input,int,isinstance,issubclass,len,list,map,max,min,object,ord,pow,print,property,py_TypeError,py_iter,py_metatype,py_next,py_reversed,py_typeof,range,repr,round,set,setattr,sorted,str,sum,tuple,zip}from"./org.transcrypt.__runtime__.js";var __name__="proxies";export var run=function(autoTester){var CodedStore=__class__("CodedStore",[object],{__module__:__name__,get __init__(){return __get__(this,function(self){try{self["__dict__"]={}}catch(__except0__){}})},get __setattr__(){return __get__(this,
function(self,py_name,message){self.__dict__["_"+py_name]="coded_"+message})},get __getattr__(){return __get__(this,function(self,py_name){return"decoded_"+self.__dict__["_"+py_name]})},get peek(){return __get__(this,function(self,py_name){return self.__dict__["_"+py_name]})}});var s=CodedStore();s.john="brown";s.mary="white";autoTester.check(s.peek("john"));autoTester.check(s.peek("mary"));autoTester.check(s.john);autoTester.check(s.mary);var A=__class__("A",[object],{__module__:__name__,get __init__(){return __get__(this,
function(self){self.p=1;self.q=2})}});var B=__class__("B",[A],{__module__:__name__,get __getattr__(){return __get__(this,function(self,py_name){return"Faked {}".format(py_name)})}});var C=__class__("C",[A],{__module__:__name__,get __setattr__(){return __get__(this,function(self,py_name,value){autoTester.check("Set faked {}".format(py_name));A.__setattr__(self,py_name,value)})}});var D=__class__("D",[B,C],{__module__:__name__});var a=A();var b=B();var c=C();var d=D();autoTester.check(a.p,a.q);a.p=
3;autoTester.check(a.p,a.q);autoTester.check(b.p,b.q,b.r,b.s);b.p=4;b.r=5;autoTester.check(b.p,b.q,b.r,b.s);autoTester.check(c.p,c.q);c.p=6;c.q=7;autoTester.check(c.p,c.q);autoTester.check(d.p,d.q,d.r,d.s);d.p=8;d.q=9;d.r=10;d.s=11;autoTester.check(d.p,d.q,d.r,d.s);autoTester.check("Issue 587");var Element=__class__("Element",[object],{__module__:__name__,get __init__(){return __get__(this,function(self){self.message="Goodbye"})},get sayBye(){return __get__(this,function(self){autoTester.check(self.message)})}});
...
return result})},get sayHello(){return __get__(this,function(self){autoTester.check("Hello");return self})}});var e=Element();var w=Wrapper(e);e.sayBye();w.sayBye();w.sayHello().sayBye();w.message="Bye";e.sayBye();w.sayBye();w.sayHello().sayBye();autoTester.check("End issue 587")};
