...
a,b){autoTester.check(cls.__name__,a,b);return a+b}))},get mystaticmethod(){return function(a,b){autoTester.check(a,b);return a+b}},get _get_inner_property(){return __get__(this,function(self){return"I am a property"})}})),get __init__(){return __get__(this,function(self){self.greetings="Hello"})},get get_greetings(){return __get__(this,__call__(__call__(adecorator,null,__kwargtrans__({greetings:"Goodbye"})),null,function(self){return self.greetings}))},get mymethod(){return __get__(this,method_decorator("first_")(method_decorator2("second_")(function(self,
py_name){autoTester.check(py_name)})))},get number(){return __get__(this,multiplier(5)(function(self,num){return num}))},get myclassmethod(){return __getcm__(this,function(cls,a,b){autoTester.check(cls.__name__,a,b);return a+b})},get mystaticmethod(){return function(a,b){autoTester.check(a+b);return a+b}},get _get_simple_property(){return __get__(this,function(self){return self.greetings})},get _set_simple_property(){return __get__(this,function(self,value){self.greetings=value})},get run(){return __get__(this,
function(self){var inner_obj=self.InnerClass();inner_obj.mymethod("Dog");var result1=inner_obj.myclassmethod("param1","param2");var result2=self.InnerClass.myclassmethod("param1","param2");autoTester.check(result1==result2);var result1=inner_obj.mystaticmethod("param1","param2");var result2=self.InnerClass.mystaticmethod("param1","param2");autoTester.check(result1==result2);autoTester.check(inner_obj.inner_property)})}}));Object.defineProperty(MyClass,"simple_property",property.call(MyClass,MyClass._get_simple_property,
MyClass._set_simple_property));Object.defineProperty(MyClass.InnerClass,"inner_property",property.call(MyClass.InnerClass,MyClass.InnerClass._get_inner_property));var myobj=MyClass();myobj.mymethod("Cat");autoTester.check(myobj.greetings);autoTester.check(myobj.get_greetings());var result1=myobj.myclassmethod("param1","param2");var result2=MyClass.myclassmethod("param1","param2");autoTester.check(result1==result2);var result1=myobj.mystaticmethod("param1","param2");var result2=MyClass.mystaticmethod("param1",
"param2");autoTester.check(result1==result2);autoTester.check(myobj.number(3));autoTester.check(myobj.simple_property);myobj.simple_property="New value";autoTester.check(myobj.simple_property);autoTester.check(myobj.greetings==myobj.simple_property);myobj.run()};
