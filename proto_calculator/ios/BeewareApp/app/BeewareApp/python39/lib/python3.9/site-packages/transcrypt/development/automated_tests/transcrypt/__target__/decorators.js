...
repeat3(repeatN(2)(function(a){if(arguments.length){var __ilastarg0__=arguments.length-1;if(arguments[__ilastarg0__]&&arguments[__ilastarg0__].hasOwnProperty("__kwargtrans__")){var __allkwargs0__=arguments[__ilastarg0__--];for(var __attrib0__ in __allkwargs0__)switch(__attrib0__){case "a":var a=__allkwargs0__[__attrib0__];break}}}else;autoTester.check("eggs",a)}));funcArg(3);autoTester.check();funcArg(__kwargtrans__({a:4}));autoTester.check();var funcNoArg2=__call__(__call__(Repeater,null,3),null,
function(){(function(){var __accu0__=autoTester;return __call__(__accu0__.check,__accu0__,"toast")})()});funcNoArg2();autoTester.check();var funcArg2=__call__(__call__(Repeater,null,5),null,function(a){if(arguments.length){var __ilastarg0__=arguments.length-1;if(arguments[__ilastarg0__]&&arguments[__ilastarg0__].hasOwnProperty("__kwargtrans__")){var __allkwargs0__=arguments[__ilastarg0__--];for(var __attrib0__ in __allkwargs0__)switch(__attrib0__){case "a":var a=__allkwargs0__[__attrib0__];break}}}else;
(function(){var __accu0__=autoTester;return __call__(__accu0__.check,__accu0__,"jam",a)})()});funcArg2(3);autoTester.check();funcArg2(__kwargtrans__({a:4}));autoTester.check();var py_next=function(bareFunc){var innerFunc=function(value){return bareFunc(value+1)};return innerFunc};var Number=py_next(__class__("Number",[object],{__module__:__name__,get __init__(){return __get__(this,function(self,value){self.value=value})}}));autoTester.check("two",Number(1).value);var Test=__class__("Test",[object],
{__module__:__name__,get f(){return __getcm__(this,function(cls,x,y){autoTester.check(cls.__name__,x,y)})},get g(){return __get__(this,function(self,x,y){autoTester.check(self.__class__.__name__,x,y)})}});var test=Test();test.f(1,2);test.g(3,4)};
