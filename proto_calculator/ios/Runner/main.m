...
//
//    NSLog(@"argc is    %d", argc);
//
//    for(int i = 0; i < argc; i++){
//        NSLog(@"argv is  %s", argv[i]);
//    }
//
//    int ret = 0;
//    PyStatus status;
...
//        NSLog(@"ressource path is %@", resourcePath);
...
//        wapp_module_name = Py_DecodeLocale("BeewareApp", NULL);
...
//        // path = [NSString stringWithFormat:@"%@/Library/Python/lib/python310.zip", resourcePath, nil];
//        // NSLog(@"- %@", path);
...
//        path = [NSString stringWithFormat:@"%@/Library/Python/lib/python3.10", resourcePath, nil];
//        NSLog(@"- %@", path);
//        wtmp_str = Py_DecodeLocale([path UTF8String], NULL);
//        status = PyWideStringList_Append(&config.module_search_paths, wtmp_str);
//        if (PyStatus_Exception(status)) {
...
//        // path = [NSString stringWithFormat:@"%@/Library/Python/lib/python3.10/lib-dynload", resourcePath, nil];
//        // NSLog(@"- %@", path);
//        // wtmp_str = Py_DecodeLocale([path UTF8String], NULL);
//        // status = PyWideStringList_Append(&config.module_search_paths, wtmp_str);
//        // if (PyStatus_Exception(status)) {
...
//            nslog_script = [
//                [[NSBundle mainBundle] pathForResource:@"Library/Application Support/com.example.BeewareApp/app_packages/nslog"
...
//            NSLog(@"Running app module: BeewareApp");
...
//
////
//                SEL methodToPerformSelector = NSSelectorFromString(@"function123");
////                NSLog(@"classAPI: %@", classAPI);
//                [[[NSClassFromString(@"Bobby") alloc] init] performSelector: methodToPerformSelector];
